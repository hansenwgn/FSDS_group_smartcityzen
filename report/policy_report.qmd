...
Once the relationship between variables has been established and determined to be positive, clustering analysis is conducted. Clustering allows objects (in this case Airbnb listings) to be grouped based on similar characteristics (ie variables) shared among them.  
